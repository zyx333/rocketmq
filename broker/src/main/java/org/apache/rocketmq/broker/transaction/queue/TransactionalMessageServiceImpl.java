            ...
            for (MessageQueue messageQueue : msgQueues) {
                ...
                while (true) {
                    ...
                    if (removeMap.containsKey(i)) {
                        ...
                        // 判断消息回查次数是否超过15次；或者消息文件是否过期（默认72h）
                        ...
                        if (null != checkImmunityTimeStr) {
                            ...
                            // 新提交的半消息暂不处理，可能事务还未处理完。提交时间大于transactionTimeout的消息才会回查
