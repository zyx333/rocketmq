...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
    ...
    /**
     * 异步发送消息。消息发送的结果通过sendCallback进行回调
     *
     ...
     * use this method.
     *
     * @param key accesskey。 可以与newTopic相同
     ...
     * @param key message key index word。 索引字段？todo
