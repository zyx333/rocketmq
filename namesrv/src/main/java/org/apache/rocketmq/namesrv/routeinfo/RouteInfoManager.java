...
public class RouteInfoManager {
    ...
    // broker 上的FilterServer列表，用于类模式消息过滤。
    ...
    // 获取集群信息。包括集群中的broker，以及每个broker的地址信息
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                ...
                // 同一个地址只能存在一个记录。所以会判断已经存在的地址，如果brokerId不同，则把老的移除
                ...
                // slave的处理逻辑
                // 如果当前broker是从节点，则查找其主节点的信息更新到结果中
        ...
        try {
            try {
                ...
                if (null != brokerData) {
                    ...
                    // 如果相同brokerName下只有这一个broker，则移除此brokerName
                ...
                if (removeBrokerName) {
                    ...
                    if (nameSet != null) {
                        ...
                        // 如果此集群下只有这一个brokerName，则移除Cluster
                        if (nameSet.isEmpty()) {
            ...
            try {
                try {
                    ...
                    while (itBrokerAddrTable.hasNext() && (null == brokerNameFound)) {
                        ...
                        // 如果移除broker后，brokerData中不再包含其他broker，则移除该brokerName
                        if (brokerData.getBrokerAddrs().isEmpty()) {
                            removeBrokerName = true;
