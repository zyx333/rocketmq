...
//        int queueId msg.getQueueId();
        ...
        try {
            ...
            //mappedFile为null，说明CommitLog目录下没有文件。则用0偏移量创建文件。
            ...
            switch (result.getStatus()) {
                case PUT_OK:
                    break;
                case END_OF_FILE: //当前文件剩余空间不够写入消息
    ...
    public CompletableFuture<PutMessageStatus> submitFlushRequest(AppendMessageResult result, MessageExt messageExt) {
        ...
        // Asynchronous flush
            ...
            if (!this.defaultMessageStore.getMessageStoreConfig().isTransientStorePoolEnable()) {
                ...
                // 如果使用了暂存池，先将数据写入到FileChannel，然后统一刷盘
        ...
        public void run() {
            ...
            while (!this.isStopped()) {
                ...
                if (begin >= (this.lastCommitTimestamp + commitDataThoroughInterval)) {
                    ...
                    // 如果距离上次提交的间隔大于commitDataThoroughInterval，则忽略最小页数的限制
                ...
                try {
                    ...
                    if (!result) { // result为false表示有数据提交成功
    ...
    public static class MessageExtEncoder {
        ...
        protected PutMessageResult encode(MessageExtBrokerInner msgInner) {
            ...
            // Exceeds the maximum message；默认限制为4M
            if (msgLen > this.maxMessageSize) {
